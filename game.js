...
function executeGrading() {
    ...
    if (gameState.level === 3) {
        ...
        const messages = {
            0: '💭 世の中ってオレより頭のいい人のほうが多いんだ。',
            1: '🛤️ 「ゴールは遠いなぁ」と、がっかりするのも道のりです。',
            2: '📅 常に今日は明日の準備ですからね。今日やったことは必ず明日に返ってくるんです。',
            3: '🪜 小さいことを積み重ねるのが、とんでもないところへ行くただひとつの道だと思っています。',
            4: '🚀 成功の反対は失敗ではなく「やらないこと」',
            5: '🧠 自分がわかっていないことがわかるということが一番賢いんです。',
            6: '🏆 強い者が勝つのではない。勝った者が強いのだ。'
        };
        resultMessage = messages[correctAnswers] || messages[6];
    } else {
        // 通常レベル（ふつう）のメッセージ
